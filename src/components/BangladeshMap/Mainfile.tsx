...
import { bangladeshDivisions, Division } from "../../data/bangladeshDivisions";
...
export const BangladeshMap = ({ onHover }: BangladeshMapProps) => {
          ...
          {bangladeshDivisions.map((division) => (
            <DivisionPath
              ...
              onClick={() => {
                ...
                alert(`Division Name: ${division.name}`);
              }}
            />
          ))}
        </g>
        ...
        <g>
          {bangladeshDivisions.map((division) => (
            <text
              ...
              style={{ 
                opacity: hoveredDivision && hoveredDivision !== division.id ? 0.3 : 1,
