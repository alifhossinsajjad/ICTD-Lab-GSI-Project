      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 no-print">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="cursor-pointer hover:scale-105 flex items-center gap-2 px-5 py-2.5 bg-green-900 hover:bg-green-950 text-white rounded-xl shadow-lg shadow-green-950/30 hover:shadow-xl transition-all text-sm font-semibold"
          >
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 w-full md:w-auto overflow-x-auto pb-2 md:pb-0">
              <button
                onClick={() => handleExport("excel")}
                className="cursor-pointer flex items-center gap-2 px-3 py-2 bg-emerald-50 text-emerald-700 rounded-lg hover:bg-emerald-100 transition-colors text-sm font-medium"
                title="Export Excel"
              >
                <FaFileExcel />
              ...
              <button
                ...
                className="cursor-pointer flex items-center gap-2 px-3 py-2 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors text-sm font-medium"
                title="Export CSV"
              >
                <FaFileCsv />
              ...
              <button
                ...
                className="cursor-pointer flex items-center gap-2 px-3 py-2 bg-gray-50 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors text-sm font-medium"
                title="Print"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-100">
            ...
            <div className="flex items-end">
              <button
                ...
                className="cursor-pointer hover:scale-105 w-full px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg shadow-sm hover:shadow transition-all text-sm font-medium flex items-center justify-center gap-2"
              >
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex flex-col gap-1">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium w-fit ${lab.labType === "sof" ? "bg-blue-100 text-blue-800" : "bg-purple-100 text-purple-800"}`}>
