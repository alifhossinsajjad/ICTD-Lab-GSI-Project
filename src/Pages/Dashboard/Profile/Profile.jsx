  ...
  return (
    <div className="min-h-screen bg-emerald-50 p-6 lg:p-10 font-sans">
      ...
      >
        {/* Page Header */}
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-green-950">My Profile</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            ...
            >
              <div className="h-32 bg-gradient-to-r from-emerald-600 to-emerald-500  relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="pt-6 flex justify-end">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="flex justify-center items-center gap-2 bg-red-600 hover:bg-green-900 text-white px-8 py-3.5 rounded-xl font-semibold shadow-lg shadow-green-950/30 transition-all duration-300 w-full md:w-auto cursor-pointer"
                  >
