...
const LabDetails = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 pt-10 pb-2 px-12 relative">
            <div className="max-w-[1800px] mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-600 text-lg">
                        Find laboratories near you with interactive map
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-gray-900">{selectedLab.district}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="text-sm font-semibold text-gray-700">Upazila</p>
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="text-sm font-semibold text-gray-700">Head</p>
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="text-sm font-semibold text-gray-700">Address (from GPS)</p>
                                                    {isFetchingAddress ? (
                                                        <p className="text-gray-500 text-sm animate-pulse">Fetching address...</p>
                                                    ) : (
                    ...
                    >
                        <div className="bg-white rounded-2xl shadow-2xl border-2 border-emerald-200 h-[600px] lg:h-[calc(100vh-180px)] sticky top-[72px]">
                            <MapContainer
                                center={mapCenter}
                                zoom={8}
                            ...
                            >
                                ...
                                {visibleMapLabs.map((lab, index) => {
                                    if (lab.lat === 0 || lab.long === 0 || !lab.lat || !lab.long) return null;
                                            ...
                                            <Popup>
                                                <div className="min-w-[200px]">
                                                    ...
                                                    <div className="space-y-1 text-sm">
                                                        <p>
                                                            <span className="font-semibold">District:</span> {lab.district}
                                                        </p>
                                                        <p>
                                                            <span className="font-semibold">Upazila:</span> {lab.upazila}
                                                        </p>
                                                        <p>
                                                            <span className="font-semibold">Head:</span> {lab.head}
                                                        </p>
                                                        <p>
                                                            <span className="font-semibold">Phone:</span> {lab.mobile}
                                                        </p>
                                                    </div>
                                                </div>
                                            </Popup>
                    ...
                    >
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl border-2 border-emerald-200 p-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className={`w-full ${!currentLocation ? "opacity-50 cursor-not-allowed" : ""} bg-gray-50 border-2 border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600 outline-none transition-all shadow-sm hover:border-emerald-400`}
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl border-2 border-emerald-200 p-6 max-h-[400px] overflow-y-auto">
                            <h3 className="text-xl font-bold text-gray-800 mb-4">Nearby Labs</h3>
                            ...
                            <div className="space-y-3">
                                ...
                                {filteredLabs.length === 0 && (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-gray-500 text-sm">No labs found in this area</p>
                                    </div>
                                )}
                            </div>
                        </div>
